...
class SchemeContentScreen extends StatefulWidget {
  final dynamic argument;
  const SchemeContentScreen({super.key, this.argument});

  @override
  State<SchemeContentScreen> createState() => _SchemeContentScreenState();
}

class _SchemeContentScreenState extends State<SchemeContentScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    int schemeId = widget.argument['schemeId'];
